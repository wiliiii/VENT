	...
	class productController extends mainModel{
		...
		public function listarProductoControlador($pagina,$registros,$url,$busqueda,$categoria){
			...
			if(isset($busqueda) && $busqueda!=""){
				...
				$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id WHERE producto_codigo LIKE '%$busqueda%' OR producto_nombre LIKE '%$busqueda%' OR producto_marca LIKE '%$busqueda%' OR producto_modelo LIKE '%$busqueda%' ORDER BY producto_nombre ASC LIMIT $registros OFFSET $inicio";
		        ...
		        $consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id WHERE producto.categoria_id='$categoria' ORDER BY producto.producto_nombre ASC LIMIT $registros OFFSET $inicio";

		        $consulta_total="SELECT COUNT(producto_id) FROM producto WHERE categoria_id='$categoria'";

		    }else{

				$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id ORDER BY producto_nombre ASC LIMIT $registros OFFSET $inicio";
		...
		public function eliminarProductoControlador(){
			...
			$check_ventas->bindParam(":id", $id, PDO::PARAM_INT);
			$check_ventas->execute();
