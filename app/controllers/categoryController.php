<?php
	...
	class categoryController extends mainModel{
		...
		public function registrarCategoriaControlador(){
			...
			# Guardando los datos de la categoría #
			$categoria_datos_reg = [
				[
		...
		public function listarCategoriaControlador($pagina, $registros, $url, $busqueda){
			...
			if(isset($busqueda) && $busqueda != ""){
				$consulta_datos = "SELECT * FROM categoria WHERE categoria_nombre LIKE '%$busqueda%' OR categoria_ubicacion LIKE '%$busqueda%' ORDER BY categoria_nombre ASC LIMIT $registros OFFSET $inicio";
				...
				$consulta_datos = "SELECT * FROM categoria ORDER BY categoria_nombre ASC LIMIT $registros OFFSET $inicio";
		...
		public function actualizarCategoriaControlador(){
			...
			# Actualizando los datos de la categoría #
			$categoria_datos_up = [
				[
					"campo_nombre" => "categoria_nombre",
					"campo_marcador" => ":Nombre",
